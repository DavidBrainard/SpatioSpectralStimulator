...
%% Read the current values of the projector
clear; close all;
...
primaryColor = 1; % primaryColor should be a value of either 0, 1 or 2.
subColor = 1; % subColor is value between 0 and 15. / *Note: selecting subColor 8 does not have any effect

% Read the current info from the projector
current  = Datapixx('GetPropixxHSLedCurrent',primaryColor,subColor);
% currents = Datapixx('GetPropixxHSLedCurrents',primaryColor)

%% Set and save the currents as you wish
% current = 0;
currents = zeros(1,16);
...
% Datapixx('SetPropixxHSLedCurrent' , primaryColor, subColor, current);
Datapixx('SetPropixxHSLedCurrents' , primaryColor, currents);
Datapixx('SavePropixxHSLedCurrents');
