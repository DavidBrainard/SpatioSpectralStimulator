function [gaborImage, gaborCalUnquantized, gaborCalQuantized, stimulusN, centerN, gaborSizeDeg, gaborSizeMeters] = ...
    MakeMonochromeContrastGaborMel(stimulusSizeDeg,sineFreqCyclesPerDeg,gaborSdDeg,screenSizeObj,options)
% Make a monochrome gabor patch image.
%
% Syntax:
%    [gaborImage, gaborCal, stimulusN, centerN, gaborSizeDeg, gaborSizeMeters] = ...
%       MakeMonochromeGaborMel(stimulusSizeDeg,sineFreqCyclesPerDeg,gaborSdDeg,screenPixelsPerDeg,screenDpm)
%
% Description:
...
%
%    In this version, zero phase is at the center of the image, which was
%    not true in the non-mel version.
%
% Inputs:
...
rawMonochromeSineImage = MakeSineImage(0,sineFreqCyclesPerImage,stimulusN,stimulusN,centerN,centerN);
