function [bgPrimaries,bgSpd,bgCoords] = FindDesiredBackgroundPrimaries(targetBgCoords,T,subPrimaryCalstructData, ...
...
%
% Syntax:
%    [bgPrimaries,bgSpd,bgCoords] = FindDesiredBackgroundPrimaries(targetBgCoords,T,subPrimaryCalstructData, ...
